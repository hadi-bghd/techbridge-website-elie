...
function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>IT Solutions in Lebanon | TechBridge Group</title>
        <meta
          name="description"
          content="TechBridge Group provides IT solutions in Lebanon, including managed IT services, IT support, network infrastructure, cybersecurity, cloud solutions, software development, graphic design, and CCTV installation services."
        />
      </Helmet>
