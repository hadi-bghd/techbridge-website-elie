...
function ITSupport() {
  const pageUrl = "https://tech-bridgegroup.com/it-support";

  return (
    <>
      <Helmet>
        <title>IT Support Services in Lebanon | TechBridge Group</title>

        <meta
          name="description"
          content="Professional IT support services in Lebanon, including remote and on-site support, troubleshooting, system maintenance, helpdesk support, and managed IT services for businesses."
        />

        <link rel="canonical" href={pageUrl} />

        <meta property="og:title" content="IT Support Services in Lebanon | TechBridge Group" />
        <meta
          property="og:description"
          content="Reliable IT support and managed IT services for businesses in Lebanon, including troubleshooting, maintenance, helpdesk support, and infrastructure support."
        />
